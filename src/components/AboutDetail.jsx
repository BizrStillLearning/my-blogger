...
import { X, BookOpen, Code, Coffee, Target } from 'lucide-react';
                ...
                <div className="fixed inset-0 z-[9999] pointer-events-none flex">
                    ...
                    >
                        <div className="p-6 flex items-center justify-between border-b" style={{ borderColor: 'rgba(var(--text-main-rgb), 0.05)' }}>
                            ...
                            <button
                                onClick={onClose}
                                className="p-2 rounded-xl opacity-50 hover:opacity-100 hover:bg-white/5 transition-all cursor-pointer"
                        ...
                        <div className="flex-1 overflow-y-auto p-8 space-y-10 custom-scrollbar">
                            ...
                            <div className="space-y-4">
                                ...
                                <p className="text-sm opacity-70 leading-relaxed font-medium" style={{ color: 'var(--text-main)' }}>
                                    {t('aboutDetail.currentExplorationText')}
                                </p>
                            </div>

                            <div className="space-y-4">
                                <div className="flex items-center gap-2 opacity-40">
                                    <Target size={16} style={{ color: 'var(--text-main)' }} />
                                    <span className="text-[10px] font-black uppercase tracking-widest" style={{ color: 'var(--text-main)' }}>Future Goals</span>
                                </div>
                                <p className="text-sm opacity-70 leading-relaxed font-medium" style={{ color: 'var(--text-main)' }}>
                                    {t('aboutDetail.futureGoalsText')}
                                </p>
                            </div>
