...
const TimelineCard = ({ itemKey, icon: Icon, side, index, isLast }) => {
    ...
    return (
        <div ref={cardRef} className={`relative flex items-center justify-between mb-12 md:mb-20 w-full ${isLeft ? 'md:flex-row-reverse' : 'md:flex-row'} flex-col`}>

            <div className={`absolute left-1/2 -translate-x-1/2 w-[2px] bg-gradient-to-b from-[var(--accent)] to-transparent opacity-40 hidden md:block z-0 ${isLast ? 'h-[100%]' : 'h-[calc(100%+5rem)]'}`}
                 style={{ top: '40px' }} />
            ...
            <motion.div
                ...
                className="w-full md:w-[45%] p-7 md:p-8 rounded-[2rem] border backdrop-blur-md relative overflow-hidden group transition-all duration-500 z-10"
                style={{
            ...
            >
                ...
                >
                    <Binary size={140} strokeWidth={1} style={{ color: 'var(--accent)' }} />
                </motion.div>
                ...
                <div className="relative z-10">
                    <div className="flex items-center gap-4 md:gap-5 mb-5">
                        <div className="p-3.5 md:p-4 rounded-2xl shadow-inner transition-colors group-hover:bg-white/5 border"
                        ...
                        <div>
                            ...
                            <p className="text-[10px] opacity-50 font-bold uppercase tracking-widest leading-none mt-1.5">
                                {t(`timeline.items.${itemKey}.subtitle`)}
                            </p>
                        </div>
                    </div>

                    <p className="text-sm leading-relaxed opacity-70 mb-2 font-medium" style={{ color: 'var(--text-main)' }}>
...
const Timeline = () => {
    ...
    return (
        <section id="timeline" className="py-20 md:py-24 relative overflow-hidden bg-transparent">
